...
def new_session(account_id, region_name):
    try:
        ...
        credentials = sts_connection.assume_role(
            RoleArn=f"arn:aws:iam::{account_id}:role/{SWITCH_ROLE}", RoleSessionName=account_id
        )
...
def lambda_handler(event, context):
    ...
    try:
        ...
        client = session.client(service_name="eks")
        cluster_details = client.describe_cluster(name=cluster_name)
